...
const FLOATING_SHADOW =
  "shadow-[0_20px_50px_-12px_rgba(0,0,0,0.2)] dark:shadow-[0_24px_60px_-16px_rgba(0,0,0,0.55)]";

/** Decorative floating cards - ChronoTask-style depth */
function FloatingCards() {
  return (
    ...
    >
      <div
        className={`absolute left-[3%] top-[10%] w-[13.5rem] -rotate-6 rounded-2xl border border-zinc-100 bg-white p-3 ${FLOATING_SHADOW} dark:border-zinc-700 dark:bg-zinc-800`}
      >
      ...
      <div
        className={`absolute right-[4%] top-[8%] w-[12rem] rotate-[7deg] rounded-2xl border border-zinc-100 bg-white p-4 ${FLOATING_SHADOW} dark:border-zinc-700 dark:bg-zinc-800`}
      >
      ...
      <div
        className={`absolute bottom-[12%] left-[5%] w-[14rem] rotate-[3deg] rounded-2xl border border-zinc-100 bg-white p-4 ${FLOATING_SHADOW} dark:border-zinc-700 dark:bg-zinc-800`}
      >
      ...
      <div
        className={`absolute bottom-[10%] right-[4%] w-[12rem] -rotate-[5deg] rounded-2xl border border-zinc-100 bg-white p-4 ${FLOATING_SHADOW} dark:border-zinc-700 dark:bg-zinc-800`}
      >
...
function TestimonialCard({
  ...
  return (
    <blockquote className="flex h-full flex-col rounded-3xl border border-zinc-100 bg-white p-6 shadow-[0_12px_40px_-18px_rgba(0,0,0,0.15)] dark:border-zinc-800 dark:bg-zinc-900">
...
export default function HomeLandingPage() {
  ...
  return (
    <div className="flex min-w-0 flex-1 flex-col bg-zinc-200/55 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-50">
      <div className="mx-auto w-full max-w-7xl px-3 pb-20 pt-6 sm:px-4 lg:px-8 lg:pb-24 lg:pt-10">
        {/* --- Main bento hero --- */}
        <div className="overflow-hidden rounded-[2rem] border border-white/70 bg-white shadow-[0_32px_80px_-28px_rgba(15,23,42,0.28)] dark:border-zinc-800 dark:bg-zinc-900 dark:shadow-black/50">
          <nav className="flex flex-wrap items-center justify-between gap-3 border-b border-zinc-100 px-4 py-4 sm:px-8 dark:border-zinc-800">
            <Link href="/" className="flex min-w-0 items-center gap-3">
              <Image
                ...
                width={44}
                height={44}
                className="h-11 w-11 shrink-0 rounded-2xl bg-zinc-50 shadow-md ring-1 ring-zinc-200/80 dark:bg-zinc-800 dark:ring-zinc-600"
                priority
              />
              <span className="truncate text-lg font-bold tracking-tight">{t("nav.brand")}</span>
            </Link>
            <div className="hidden items-center gap-8 text-sm font-medium text-zinc-600 md:flex dark:text-zinc-400">
              <Link href="/map" className="transition hover:text-sky-600 dark:hover:text-sky-400">
                {t("nav.map")}
              </Link>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <Link
                href="/login"
                className="rounded-xl px-3 py-2 text-sm font-semibold text-zinc-700 transition hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-800"
              >
                {t("home.login")}
              </Link>
              <Link
                href="/login"
                className="rounded-xl bg-sky-600 px-4 py-2.5 text-sm font-semibold text-white shadow-md shadow-sky-900/20 transition hover:bg-sky-500"
              >
                {t("home.getStarted")}
              </Link>
            </div>
          ...
          <div className="home-landing-dot-bg relative min-h-[400px] px-4 pb-24 pt-14 sm:min-h-[440px] sm:pb-28 sm:pt-16 lg:min-h-[500px]">
            <FloatingCards />
            <div className="relative z-10 mx-auto max-w-2xl text-center">
              <div className="mx-auto mb-8 flex justify-center">
                <div className="rounded-[1.35rem] bg-white p-4 shadow-[0_16px_48px_-12px_rgba(0,0,0,0.18)] ring-1 ring-zinc-200/90 dark:bg-zinc-800 dark:ring-zinc-600">
                  <div className="grid grid-cols-2 gap-1.5 rounded-xl bg-zinc-50 p-2 dark:bg-zinc-900/80">
              ...
              <p className="mx-auto mt-6 max-w-lg text-lg leading-relaxed text-zinc-500 dark:text-zinc-400">
                {t("home.landing.bento.subhead")}
              </p>
              <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
                <Link
                  href="/login"
                  className="inline-flex min-h-12 items-center justify-center rounded-2xl bg-sky-600 px-8 py-3.5 text-sm font-semibold text-white shadow-lg shadow-sky-900/25 transition hover:bg-sky-500"
                >
                  {t("home.getStarted")}
                </Link>
                <Link
                  href="/map"
                  className="inline-flex min-h-12 items-center justify-center rounded-2xl border border-zinc-300/90 bg-white px-8 py-3.5 text-sm font-semibold text-zinc-800 shadow-sm transition hover:bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-white dark:hover:bg-zinc-700"
                >
                  {t("home.openMap")}
                </Link>
              </div>
              <p className="mx-auto mt-8 max-w-md text-sm leading-relaxed text-zinc-400 dark:text-zinc-500">
        ...
        <section className="mx-auto mt-16 max-w-6xl px-2 text-center">
          <span className="inline-flex rounded-full border border-zinc-200 bg-white px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-zinc-500 shadow-sm dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-400">
          ...
          <div className="mt-12 grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-3xl border border-zinc-100 bg-white p-7 text-center shadow-lg shadow-zinc-900/5 dark:border-zinc-800 dark:bg-zinc-900">
              <SolutionIcon>
            ...
            <div className="flex justify-center md:col-span-2 lg:col-span-3">
              <div className="w-full max-w-md rounded-3xl border border-zinc-100 bg-white p-7 text-center shadow-lg shadow-zinc-900/5 dark:border-zinc-800 dark:bg-zinc-900 lg:max-w-sm">
                <SolutionIcon>
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        {/* --- Features bento grid --- */}
        <section className="mt-20 overflow-hidden rounded-[2rem] border border-zinc-100 bg-white px-5 py-12 shadow-[0_28px_70px_-35px_rgba(0,0,0,0.2)] dark:border-zinc-800 dark:bg-zinc-900 sm:px-10 sm:py-14">
          <div className="mx-auto max-w-3xl text-center">
            <span className="inline-flex rounded-full border border-zinc-200 bg-zinc-50 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-zinc-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400">
          ...
          <div className="mx-auto mt-12 grid max-w-6xl gap-5 md:grid-cols-2">
            <article className="group overflow-hidden rounded-3xl border border-zinc-100 bg-zinc-50/50 shadow-lg transition hover:shadow-xl dark:border-zinc-800 dark:bg-zinc-800/40">
            ...
            <article className="group overflow-hidden rounded-3xl border border-zinc-100 bg-zinc-50/50 shadow-lg transition hover:shadow-xl md:col-span-2 dark:border-zinc-800 dark:bg-zinc-800/40 lg:col-span-1">
            ...
            <article className="flex flex-col justify-center rounded-3xl border border-zinc-100 bg-gradient-to-br from-sky-600 to-indigo-700 p-8 text-white shadow-lg md:col-span-2 lg:col-span-1">
        ...
        {/* --- Final CTA --- */}
        <section className="mt-20 overflow-hidden rounded-[2rem] border border-zinc-100 bg-gradient-to-b from-white to-zinc-50 px-6 py-14 text-center shadow-xl dark:border-zinc-800 dark:from-zinc-900 dark:to-zinc-950 sm:px-10">
          <h2 className="text-3xl font-bold text-zinc-900 dark:text-white">{t("home.landing.ctaTitle")}</h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-zinc-600 dark:text-zinc-400">{t("home.landing.ctaBody")}</p>
          <div className="mt-10 flex flex-wrap justify-center gap-3">
            <Link
              href="/login"
              className="inline-flex min-h-12 items-center justify-center rounded-2xl bg-sky-600 px-10 py-3.5 text-sm font-semibold text-white shadow-lg shadow-sky-900/20 transition hover:bg-sky-500"
            >
              {t("home.getStarted")}
            </Link>
            <Link
              href="/map"
              className="inline-flex min-h-12 items-center justify-center rounded-2xl border border-zinc-300 bg-white px-10 py-3.5 text-sm font-semibold text-zinc-800 shadow-sm transition hover:bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-white dark:hover:bg-zinc-700"
            >
              {t("home.openMap")}
            </Link>
          </div>
