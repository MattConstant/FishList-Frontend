...
export function NavBar() {
  ...
  return (
    <header className="sticky top-0 z-[1100] shrink-0 border-b border-zinc-200/80 bg-white/90 pt-[env(safe-area-inset-top)] backdrop-blur dark:border-white/[0.07] dark:bg-[#0f1624]/82 dark:backdrop-blur-md">
