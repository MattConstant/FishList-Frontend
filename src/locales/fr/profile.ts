export default {
  ...
  "profile.viewPhotos": "{{n}} photos",
  "profile.hidePhotos": "Masquer",
  "profile.loadingPhotos": "Chargement des photos…",
  "profile.photoLoadError": "Impossible de charger les photos.",
  "profile.passwordResetTitle": "Mot de passe",
  "profile.passwordResetDesc":
    "Nous enverrons un lien de reinitialisation a {{email}}. Le lien expire dans environ une heure.",
  "profile.passwordResetEmailFallback": "votre courriel enregistre",
  "profile.passwordResetButton": "Envoyer le lien",
  "profile.passwordResetSending": "Envoi…",
  "profile.passwordResetFailed": "Impossible d'envoyer le courriel de reinitialisation.",
