export default {
  ...
  "profile.hidePhotos": "Hide",
  "profile.loadingPhotos": "Loading photos…",
  "profile.photoLoadError": "Could not load photos.",
  "profile.passwordResetTitle": "Password",
  "profile.passwordResetDesc":
    "We will email a reset link to {{email}}. The link expires in about an hour.",
  "profile.passwordResetEmailFallback": "your registered email",
  "profile.passwordResetButton": "Email reset link",
  "profile.passwordResetSending": "Sending…",
  "profile.passwordResetFailed": "Could not send the reset email.",
